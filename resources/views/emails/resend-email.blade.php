...
<body>
    <div class="container">
        ...
        <p>You've requested to resend the activation email. To activate your account, click the button below:</p>
        <p>Position : <span class="badge bg-warning text-capitalize">{{ $position ?? '' }}</span> </p>
        <p>Role : <span class="badge bg-success text-capitalize">{{ $role ?? '' }}</span> </p>
        <p>Status : <span
